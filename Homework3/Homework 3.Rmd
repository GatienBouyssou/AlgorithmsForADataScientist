...
\item \ textbf{Largest tiles} : It is the itemset with the biggest area in a dataset. The area is equal to the frequency multiplied by the size of the dataset.
\end
...
With the method "first" : The first method depicts the firsst value which is the running time of method M1.
...
With the method "majority" : The majority method depicts the second value value which is the running time of method M2.
