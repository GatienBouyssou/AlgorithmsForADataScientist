...
rulesAdult <- ruleInduction(frequentItemsAdult, Adult, confidence = 0.95, control = list(method = "apriori"))
...
```{r, eval=FALSE, echo=FALSE}
tennis_rules_winning <- apriori(tennis, appearance = list (default="lhs",rhs="Result=1"), parameter = list(support = 0.1, confidence = 0.4))
```

```{r, eval=TRUE, echo=FALSE}
tennis_rules_winning
inspect(head(sort(tennis_rules_winning, by = "confidence", decreasing=TRUE), 5))
```

The associations rules for Player-1 loosing : 

```{r, eval=FALSE, echo=FALSE}
tennis_rules_loosing <- apriori(tennis, appearance = list (default="lhs",rhs="Result=0"), parameter = list(support = 0.1, confidence = 0.4))
```

```{r, eval=TRUE, echo=FALSE}
tennis_rules_loosing
inspect(head(sort(tennis_rules_loosing, by = "confidence", decreasing=TRUE), 5))
```
...
```{r, eval=TRUE, echo=FALSE}
tennis_rules
inspect(head(sort(tennis_rules, by = "confidence", decreasing=TRUE), 5))
```
